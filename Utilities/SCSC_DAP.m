...
function [Alphac, Alphan, Uc, Un, Pn, f] = SCSC_DAP(Alphac, Alphan, Xc, Xn, Dc, Dn, par)
...
for t = 1 : par.nIter
    ...
    %% Updating Us and Up
    Un = Uc * Alphac * Alphan' / ( Alphan * Alphan' + par.nu * eye(size(Alphan, 1)));
    Uc = Un * Alphan * Alphac' / ( Alphac * Alphac' + par.nu * eye(size(Alphac, 1)));
